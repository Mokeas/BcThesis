...
Here are multiple examples of lexicalization and realisation of one preverbal message:
\begin{itemize}
...
Here we show two examples of generated articles for the \textit{example\_match}. Messages to generate are visible from \figref{example}, but we will state couple of first along with the title message:
