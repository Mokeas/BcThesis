\chapter{A- NLG Tasks}\label{chap:tasks}
...
In this section of the article we will discuss every task mentioned above. Note that approaches, which will be described later, may change this structure - there might be just a few changes by combining multiple steps and process them simultaneously or the structure may be completely decomposed. 
...
\section{B - Content determination}
...
(TODO  -A -  teď krátce popsat další nástrahy - vlkádání slov, předložek, interpunkce, zajišťovat shody - je to ttrochu napsaný v NLG articlu)

(TODO  -A -  O TEMPLATÁCH A GRAMATIKÁCH v rámci realizace, pak to projet google doc překladačem)

(TODO  -A -  pak se vrhnout na přepsání corpusu ve smyslu získávání dat i automaticky, nejen hand-crafting)

(TODO  -A -  pak rozdělit approache jen na modulární a ten co to rozbíjí, ne na 3)
