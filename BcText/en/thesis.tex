...
\def\ThesisTitle{Building data-to-text Natural Language Generation system to create football articles (TODO-A-doplnit ze SISu a do názvu zapojit NLG (zde je zhruba můj návrh))}
